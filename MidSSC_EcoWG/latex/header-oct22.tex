...
\fancyheadinit{%
   \ifthenelse{\value{page}=1}%
      {\fancyhead[R]{\textsf{\emph{September 22, 2022}}}
       \fancyhead[L]{\textsf{\LARGE SSC Ecosystem Working Group Report: October 2022}}
      }%
      {\fancyhead[R]{}
       \fancyhead[L]{\textsf{\emph{SSC Ecosystem Working Group Report: October 2022}}}
      }
}
