...
\fancyheadinit{%
   \ifthenelse{\value{page}=1}%
      {\fancyhead[R]{\textsf{\emph{September 2, 2022}}}
       \fancyhead[L]{\textsf{\LARGE SSC Ecosystem Working Group Report: September 2022}}
      }%
      {\fancyhead[R]{}
       \fancyhead[L]{\textsf{\emph{SSC Ecosystem Working Group Report: September 2022}}}
      }
}
