...
\fancyheadinit{%
   \ifthenelse{\value{page}=1}%
      {\fancyhead[R]{\textsf{\emph{December 3, 2022}}}
       \fancyhead[L]{\textsf{\LARGE Using Ecosystem Information in the Stock Assessment and Advice Process}}
      }%
      {\fancyhead[R]{}
       \fancyhead[L]{\textsf{\emph{SCS7 Keynote 2 Summary}}}
      }
}
