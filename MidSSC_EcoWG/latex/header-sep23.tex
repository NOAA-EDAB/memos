...
\fancyheadinit{%
   \ifthenelse{\value{page}=1}%
      {\fancyhead[R]{\textsf{\emph{September 6, 2023}}}
       \fancyhead[L]{\textsf{\LARGE SSC Ecosystem Working Group Report: September 2023}}
      }%
      {\fancyhead[R]{}
       \fancyhead[L]{\textsf{\emph{SSC Ecosystem Working Group Report: September 2023}}}
      }
}
