...
An Indicator catalog chapter will appear here https://noaa-edab.github.io/catalog/NERRs.html
...
Work is in progress to evalaute bluefish availability inshore vs offshore along with trends in recreational fishing effort for the 2022 Bluefish Research Track Assessment. 
...
As noted under point 13, Work is in progress to evalaute bluefish availability inshore vs offshore along with trends in recreational fishing effort for the 2022 Bluefish Research Track Assessment. 
...
The National IEA HDWG is working on regime shifts in social indicators. The WG, led by Geret DePiper, has a special issue call open for Marine Policy: https://www.journals.elsevier.com/marine-policy/call-for-papers/special-issue-call-for-papers-assessing-social-change-and-ranking-outcomes-in-support-of-ecosystem-based-management-regime-shifts-nonlinearities-and-ecosystem-status We'll have one for the Northeast (Walden and DePiper, presented at the SOE synthesis meeting) and a cross regional manuscript.
...
Detailes of the work are summarized at https://sgaichas.github.io/learnR-dietdata/ExplainTrends.html. 
...
While there is investigation into these issues related to ongoing end-to-end ecosystem model development at NEFSC, qe had insufficient resources to address this as a standalone ecosystem indicator in 2021. 
