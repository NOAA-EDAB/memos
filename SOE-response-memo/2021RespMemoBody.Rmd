...
```{r glidertracks, fig.cap="Locations and timing of glider-based pH transects on the Mid-Atlantic shelf.", out.width='40%'}
...
```{r hmsbycatch, fig.cap="Example species CPUE available from HMS fishery observations.", out.width='50%'}
...
```
Correlations between the potential drivers of condition are also being explored (Fig. \ref{fig:cond-corr}).  
```{r cond-corr, fig.cap="Preliminary results: correlations between potential environmental drivers of fish condition.", out.width='80%'}
#knitr::include_url("https://github.com/NOAA-EDAB/ecodata/raw/master/docs/images/condition_proj.png")
