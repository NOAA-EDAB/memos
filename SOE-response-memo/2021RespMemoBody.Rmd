...
The MA SSC requested indices of abundance for seals rather than the narrative supplied in 2020. Analysis and review is in progress to update abundance and possibly assess trends in US waters for harbor and gray seals; however, these estimates were not available for the 2021 SOE. New information on increasing numbers of gray seal pups born at US pupping sites has been added to the narrative for both SOE reports [@wood_rates_2020]. A plot visualizing pup rates of increase has been added to the NEFMC SOE, as it is most relevant to the Gulf of Maine.
