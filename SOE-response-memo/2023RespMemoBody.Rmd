...
Some experimental short term forecasts of regional water temperature are currently available, and could be investigated or presented to the SSCs during the 2024 cycle if this remains a high priority. Skill assessment of these forecasts, as well as determining the context in which they would be used (stock assessment projections? habitat projections? other uses?) would be needed to bring them into the management process. This project would require a similar level of effort to the one above. 
...
Many projects are currently in progress. 
