...
flextable::flextable(regimestab) %>% 
  flextable::theme_zebra() %>%
  flextable::set_caption("Selected Regime Shift Projects.") %>%
  #flextable::autofit() 
...
One moderate priority request was included in the 2023 SOE: a fall turnover index has been included in both the MAFMC and NEFMC reports in the Climate and Ecosystem Risks sections.
