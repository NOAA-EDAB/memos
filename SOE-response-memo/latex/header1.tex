...
\fancyheadinit{%
   \ifthenelse{\value{page}=1}%
      {\fancyhead[R]{\includegraphics[width=40pt]{images/NOAA_logo.png} \\ \textsf{\emph{February 16, 2023}}}
       \fancyhead[L]{\textsf{\LARGE DRAFT State of the Ecosystem 2023: Request Tracking Memo}}
      }%
      {\fancyhead[R]{}
       \fancyhead[L]{\textsf{\emph{DRAFT State of the Ecosystem 2023: Request Tracking Memo}}}
      }
}
