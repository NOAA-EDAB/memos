...
\fancyheadinit{%
   \ifthenelse{\value{page}=1}%
      {\fancyhead[R]{\includegraphics[width=40pt]{images/NOAA_logo.png} \\ \textsf{\emph{March 4, 2022}}}
       \fancyhead[L]{\textsf{\LARGE State of the Ecosystem 2021: Request Tracking Memo}}
      }%
      {\fancyhead[R]{}
       \fancyhead[L]{\textsf{\emph{State of the Ecosystem 2021: Request Tracking Memo}}}
      }
}
