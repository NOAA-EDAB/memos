...
\fancyheadinit{%
   \ifthenelse{\value{page}=1}%
      {\fancyhead[R]{\includegraphics[width=40pt]{images/NOAA_logo.png} \\ \textsf{\emph{March 8, 2022}}}
       \fancyhead[L]{\textsf{\LARGE State of the Ecosystem 2022: Request Tracking Memo}}
      }%
      {\fancyhead[R]{}
       \fancyhead[L]{\textsf{\emph{State of the Ecosystem 2022: Request Tracking Memo}}}
      }
}
