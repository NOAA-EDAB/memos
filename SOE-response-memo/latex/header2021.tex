...
\AddEverypageHook{%
   \ifthenelse{\value{page}=1}%
     {\rhead{\includegraphics[width=40pt]{images/NOAA_logo.png} \\ \textsf{\emph{March 18, 2021}}}
      \lhead{\textsf{\LARGE State of the Ecosystem 2021: Request Tracking Memo}}
      }%
     {\rhead{}
      \lhead{\textsf{\emph{State of the Ecosystem 2021: Request Tracking Memo}}}
     }
}
